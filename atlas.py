    ...
    try:
        ...
        if user.lower() == "what is my name":
            ...
            if name:
                ...
                print(f"Atlas: Your name is {name}.")

            else:

                print("Atlas: I don't know your name yet.")
        ...
        if user.lower().startswith("create project "):
            ...
            if create_project(project_name):
                ...
                print(f"Atlas: Project '{project_name}' created.")

            else:

                print("Atlas: Project already exists.")
        ...
        if user.lower().startswith("delete project "):
            ...
            if delete_project(project_name):
                ...
                print("Atlas: Project deleted.")

            else:

                print("Atlas: Project not found.")
        ...
        if user.lower().startswith("add task "):
            ...
            try:
                ...
                if add_task(project, task):

                    print("Atlas: Task added.")
                ...
                print(
                    "Atlas: Use -> add task <task> to <project>"
                )
